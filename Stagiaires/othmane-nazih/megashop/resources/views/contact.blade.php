...
@section('content')
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; margin-bottom: 40px;">
        ...
        <div>
            <div
                style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin-bottom: 25px;">
            ...
            <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <p style="margin-bottom: 15px;">Suivez-nous sur nos réseaux sociaux :</p>
                <div style="display: flex; gap: 15px; flex-wrap: wrap;">
                    <a href="{{ $config['social']['facebook'] }}"
                        style="color: #3498db; text-decoration: none; font-weight: bold;">📘 Facebook</a>
                    <a href="{{ $config['social']['instagram'] }}"
                        style="color: #3498db; text-decoration: none; font-weight: bold;">📷 Instagram</a>
                    <a href="{{ $config['social']['twitter'] }}"
                        style="color: #3498db; text-decoration: none; font-weight: bold;">🐦 Twitter</a>
                    <a href="{{ $config['social']['youtube'] }}"
                        style="color: #3498db; text-decoration: none; font-weight: bold;">▶️ YouTube</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section style="background: white; padding: 30px; border-radius: 8px;">
        ...
        <p style="color: #555; margin-bottom: 20px;">
            Notre siège social est situé au cœur de Paris. Vous pouvez nous rendre visite sur rendez-vous.
        </p>
        <div
